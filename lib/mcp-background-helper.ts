...
async function gatherAllReferences(
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // 🚀 ENHANCED: Smart brand detection
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  try {
    ...
    if (result && typeof result === "object") {
      ...
      if (extractedRepos.length > 0) {
        context.githubExamples = extractedRepos.map(repo =>
  ...
  try {
    ...
    try {
      ...
      // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      try {
        const { searchDuckDuckGo } = await import('./mcp-duckduckgo');
    ...
    if (rawWebResults) {
      ...
      if (extractedWeb.length > 0) {
        context.webInsights = extractedWeb.map(result =>
          `${result.title}\n` +
        ...
        context.hasReferences = true;
        console.log(`[Background MCP] ✅ Extracted ${extractedWeb.length} high-quality web results from ${searchSource}`);
      }
    }
  } catch (error) {
  ...
  if (extractedRepos.length > 0 || extractedWeb.length > 0) {
    const aggregated = aggregateExtractedData(
      extractedRepos,
      extractedWeb,
...
export function formatContextForAI(context: BackgroundContext, description: string = ""): string {
  ...
  const hasBrandMention = /\b(openai|chatgpt|claude|stripe|airbnb|uber|shopify|amazon|netflix|spotify|twitter|instagram|facebook|linkedin|github|notion|linear|figma|slack|discord)\b/i.test(description);
  ...
  if (!isBrandClone && !hasBrandMention) {
    prompt += "NOTE: Use these to inform your design, but prioritize user's specific requirements.\n";
  }
 ...
 */
export function formatEnhancedContextForAI(context: BackgroundContext, description: string = ""): string {
  if (!context.hasReferences) {
    return "";
  }

  const brandInfo = context.structured?.brandInfo;
