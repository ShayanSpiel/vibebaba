...
@layer base {
  :root {
    ...
    --input: ${borderHSL};
    --ring: ${primaryHSL};
    --radius: ${radiusValue};${stylingConfig?.enhancedColors?.semantic ? `
    ...
    --interactive-active: ${hexToHslString(stylingConfig.enhancedColors.semantic.interactiveActive)};` : ''}${stylingConfig?.enhancedColors?.shadows ? `
    ...
    --shadow-inner: ${stylingConfig.enhancedColors.shadows.inner};` : ''}${stylingConfig?.spacing ? `
    ...
    --component-gap: ${stylingConfig.spacing.layout.componentGap};` : ''}${stylingConfig?.bordering ? `
    ...
    --radius-full: ${stylingConfig.bordering.radiusScale.full};` : ''}${stylingConfig?.transitions ? `
