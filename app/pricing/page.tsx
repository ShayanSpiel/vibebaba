        ...
        <div className="border-b border-light bg-background-base/80 backdrop-blur-md sticky top-0 z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {Object.entries(PRICING_PACKAGES).map(([key, pkg]) => (
                ...
                >
                  ...
                  {key === 'pro' && (
                    <div
                      className={`absolute top-0 ${isRTL ? 'left-0 rounded-br-xl' : 'right-0 rounded-bl-xl'} bg-gradient-brand text-white px-4 py-1.5 text-xs font-semibold shadow-md`}
                    >
                      {t('popular')}
                    </div>
                  )}
                  ...
                  <div className="p-6 flex flex-col h-full">
                    ...
                    <div className="mb-6">
                      ...
                      >
                        {key === 'unlimited' && customTokens > 0
                          ? formatPrice(
                              pkg.price + calculateCustomPrice(),
                              pkg.priceToman + calculateCustomPrice()
                            )
                    ...
                    <div className={`space-y-3 ${key === 'unlimited' ? 'mb-6' : 'flex-1'}`}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm font-medium text-text-primary">All AI models</div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm font-medium text-text-primary">Download code</div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm font-medium text-text-primary">Publish app</div>
                      </div>
                      ...
                      {key !== 'starter' && (
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-sm font-medium text-text-primary">Custom domain</div>
                        </div>
                      )}
                      ...
                      {key !== 'starter' && (
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-sm font-medium text-text-primary">
                            +{formatTokens(pkg.dailyTokens)} daily credit
                            {key === 'unlimited' ? '+' : ''}
                          </div>
                        </div>
                      )}
                          ...
                          <div className="p-4 bg-success/10 rounded-xl border border-success/30">
                            ...
                            <div className="custom-select relative">
                              ...
                              >
                                ...
                                <option value={100000}>
                                  +100K tokens • {currency === 'USD' ? '+$1' : '+70K'}
                                </option>
                                <option value={250000}>
                                  +250K tokens • {currency === 'USD' ? '+$3' : '+210K'}
                                </option>
                                <option value={500000}>
                                  +500K tokens • {currency === 'USD' ? '+$5' : '+350K'}
                                </option>
                                <option value={1000000}>
                                  +1M tokens • {currency === 'USD' ? '+$10' : '+700K'}
                                </option>
                                <option value={2500000}>
                                  +2.5M tokens • {currency === 'USD' ? '+$25' : '+1.75M'}
                                </option>
                                <option value={5000000}>
                                  +5M tokens • {currency === 'USD' ? '+$50' : '+3.5M'}
                                </option>
                              </select>
                    ...
                    <div className="mt-auto">
                      ...
                      >
                        {loading === key || (key === 'unlimited' && loading === 'custom')
                          ? t('processing')
                          : t('getStarted')}
                      </Button>
                    </div>

                    <p className="text-center text-xs text-text-tertiary mt-3">Cancel anytime</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold mb-3 text-text-primary">{t('faqTitle')}</h2>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  >
                    <h4 className="font-semibold text-text-primary text-lg pr-4 group-hover:text-brand-primary transition-colors">
                      {faq.q}
                    </h4>
                    <div
