        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          <div className="space-y-8">
            ...
            <div className="bg-background-raised rounded-xl border border-border-light overflow-hidden shadow-lg">
              ...
              <div className="p-8">
                ...
                <div className="space-y-5">
                  <Input label={t('name')} type="text" value={user.name || ''} disabled />
            ...
            <div className="bg-background-raised rounded-xl border border-border-light overflow-hidden shadow-lg">
              ...
              <div className="p-8">{/* Preferences content can be added here */}</div>
            </div>
            ...
            <div className="bg-background-raised rounded-xl border border-border-light overflow-hidden shadow-lg">
              ...
              <div className="p-8">{/* Security content can be added here */}</div>
            </div>
          </div>
        </main>
      </div>
