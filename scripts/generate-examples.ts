/**
 * Generate Examples Script
 * Generates design examples for categories using AI
 */
...
async function generateExamples(options: GenerationOptions = {}) {
  ...
  try {
    // Skip admin authentication - using public collection rules instead
    console.log('⚠️  Running without authentication (using public collection rules)\n');
